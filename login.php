      ...
      <div class="signin-signup">
        ...
        <form method="post" class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input type="text" placeholder="Email" name="email" required id="email" value="<?= htmlspecialchars($_POST["email"] ?? "") ?>"/>
          </div>
          <div class="input-field">
          ...
          <p class="social-text">Follow Us on these Platforms for more Info</p>
        ...
        <form action="process-signup.php" method="post"  class="sign-up-form">
          ...
          <div class="input-field">
            <i class="fa fa-envelope"></i>
            <input type="email"  required placeholder="e.g. someone@domain.com" name="email"  autocomplete="on"/>
          </div>
          <div class="input-field">
            <i class="fa fa-lock"></i>
